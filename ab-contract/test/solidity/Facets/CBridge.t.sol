...
import { CBridgeFacet } from "app/Facets/CBridgeFacet.sol";
import { ICBridge } from "app/Interfaces/ICBridge.sol";
...
contract CBridgeFacetTest is TestBaseFacet {
    ...
    function initiateBridgeTxWithFacet(bool isNative) internal override {
        ...
        if (isNative) {
            cBridge.startBridgeTokensViaCBridge{ value: bridgeData.preBridgeAmount }(bridgeData, data);
        } else {
    ...
    function testRevert_WillRevertIfNotEnoughMsgValue() public {
        ...
        cBridge.startBridgeTokensViaCBridge{ value: bridgeData.preBridgeAmount - 1 }(bridgeData, data);
