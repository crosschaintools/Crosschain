...
import { LibAllowList, TestBaseFacet, console, Diamond } from "../utils/TestBaseFacet.sol";
import { OnlyContractOwner, InvalidConfig, AlreadyInitialized } from "src/Errors/GenericErrors.sol";
import { StargateFacet } from "app/Facets/StargateFacet.sol";
import { IStargateRouter } from "app/Interfaces/IStargateRouter.sol";
...
contract StargateFacetTest is TestBaseFacet {
    ...
    function setUp() public {
        ...
        bridgeData.preBridgeAmount = defaultUSDCAmount;
    ...
    function initiateBridgeTxWithFacet(bool isNative) internal override {
        if (isNative) {
            stargateFacet.startBridgeTokensViaStargate{
                value: bridgeData.preBridgeAmount + addToMessageValue
