...
import { OptimismBridgeFacet } from "app/Facets/OptimismBridgeFacet.sol";
import { IApp } from "app/Interfaces/IApp.sol";
import { LibSwap } from "app/Libraries/LibSwap.sol";
import { LibAllowList } from "app/Libraries/LibAllowList.sol";
import { ERC20 } from "solmate/tokens/ERC20.sol";
import { UniswapV2Router02 } from "../utils/Interfaces.sol";
import { IL1StandardBridge } from "app/Interfaces/IL1StandardBridge.sol";
import "app/Errors/GenericErrors.sol";
...
contract OptimismBridgeFacetTest is DSTest, DiamondTest {
    ...
    function setUp() public {
        ...
        OptimismBridgeFacet.OptimismConfig[]
            memory configs = new OptimismBridgeFacet.OptimismConfig[](1);
        configs[0] = OptimismBridgeFacet.OptimismConfig(DAI_L1_ADDRESS, DAI_BRIDGE);
        ...
        validBridgeData = IApp.BridgeData({
            transactionId: "",
            bridge: "optimism",
            integrator: "",
            referrer: address(0),
    ...
    function testRevertToBridgeTokensWhenSendingAmountIsZero() public {
        ...
        IApp.BridgeData memory bridgeData = validBridgeData;
        bridgeData.preBridgeAmount = 0;
    ...
    function testRevertToBridgeTokensWhenSendingNoEnoughNativeAsset() public {
        ...
        bridgeData.preBridgeAmount = 3e18;
