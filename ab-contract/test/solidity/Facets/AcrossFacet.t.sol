...
import { AcrossFacet } from "app/Facets/AcrossFacet.sol";
import { IAcrossSpokePool } from "app/Interfaces/IAcrossSpokePool.sol";
...
contract AcrossFacetTest is TestBaseFacet {
    ...
    function setUp() public {
        ...
        acrossFacet = TestAcrossFacet(payable(address(diamond)));
