...
import { LibAllowList, TestBaseFacet, console, ERC20, Diamond } from "../utils/TestBaseFacet.sol";
...
contract MultichainFacetTest is TestBaseFacet {
    ...
    function setUp() public {
        ...
        multichainFacet = TestMultichainFacet(payable(address(diamond)));
        routers = [
            ANYSWAPV4ROUTER,
    ...
    function initiateBridgeTxWithFacet(bool isNative) internal override {
        if (isNative) {
            multichainFacet.startBridgeTokensViaMultichain{
                value: bridgeData.preBridgeAmount
    ...
    function testCanBridgeMultichainTokens() public {
        ...
        bridgeData.preBridgeAmount = amountToBeBridged;
    ...
    function test_revert_RegisterRoutersWithUninitializedFacet() public {
        ...
        multichainFacet2 = TestMultichainFacet(payable(address(diamond2)));
