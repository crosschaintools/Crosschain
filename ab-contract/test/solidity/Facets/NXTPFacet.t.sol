...
import { NXTPFacet } from "app/Facets/NXTPFacet.sol";
import { ITransactionManager } from "app/Interfaces/ITransactionManager.sol";
...
contract NXTPFacetTest is TestBaseFacet {
    ...
    function initiateBridgeTxWithFacet(bool isNative) internal override {
        if (isNative) {
            nxtpFacet.startBridgeTokensViaNXTP{ value: bridgeData.preBridgeAmount }(
                bridgeData,
                nxtpData
            );
        } else {
