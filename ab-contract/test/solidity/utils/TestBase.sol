...
import { LibUtil } from "app/Libraries/LibUtil.sol";
...
abstract contract TestBase is Test, DiamondTest, IApp {
    ...
    IApp.BridgeData internal bridgeData;
    ...
    function setDefaultBridgeData() internal {
        bridgeData = IApp.BridgeData({
            ...
            preBridgeAmount: defaultUSDCAmount,
    ...
    function printBridgeData(IApp.BridgeData memory _bridgeData) internal {
        console.log("----------------------------------");
