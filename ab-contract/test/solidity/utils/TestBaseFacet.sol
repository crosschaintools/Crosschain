...
import { TestBase, Diamond, DSTest, LibSwap, IApp, LibAllowList, console, InvalidAmount, ERC20, UniswapV2Router02 } from "./TestBase.sol";
...
abstract contract TestBaseFacet is TestBase {
    ...
    function testBase_CanBridgeTokens_fuzzed(uint256 amount) public virtual {
        ...
        bridgeData.preBridgeAmount = amount;
        ...
        assertBalanceChange(ADDRESS_DAI, USER_RECEIVER, 0)
    {
        ...
        // approval
        usdc.approve(_facetTestContractAddress, bridgeData.preBridgeAmount);
    ...
    function testBase_Revert_CallerHasInsufficientFunds() public virtual {
        ...
        // vm.expectRevert(abi.encodeWithSelector(InsufficientBalance.selector, bridgeData.preBridgeAmount, 0));
        vm.expectRevert();
        initiateBridgeTxWithFacet(false);
        vm.stopPrank();
    }
