...
task(
  ...
  let files = ['MultichainFacet.sol', 'AcrossFacet.sol', 'HyphenFacet.sol', 'LibSwap.sol', 'GenericSwapFacet.sol', 'LibDiamond.sol', 'DiamondLoupeFacet.sol', 'DiamondCutFacet.sol', 'PeripheryRegistryFacet.sol', 'StargateFacet.sol', 'AmarokFacet.sol',  'CBridgeFacet.sol', 'HopFacet.sol', 'Multicall.sol', 'TcrossFacet.sol']
