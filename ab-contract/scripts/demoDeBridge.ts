...
const Diamond_ADDRESS = '0xF0e74c6438bBC9997534860968A59C70223CC53C'
...
async function main() {
  ...
  const diamond = DeBridgeFacet__factory.connect(Diamond_ADDRESS, wallet)
  ...
  // Swap and Bridge Non-Native Asset
  {
    ...
    await diamond.swapAndStartBridgeTokensViaDeBridge(
      bridgeData,
      swapData,
      deBridgeData,
      {
  ...
  // Bridge Native Asset
  {
    ...
    await diamond.startBridgeTokensViaDeBridge(bridgeData, deBridgeData, {
