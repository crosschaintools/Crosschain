...
library LibMappings {
    ...
    bytes32 internal constant STARGATE_NAMESPACE =
        keccak256("com.aggbridge.library.mappings.stargate");
    bytes32 internal constant WORMHOLE_NAMESPACE =
        keccak256("com.aggbridge.library.mappings.wormhole");
    bytes32 internal constant AMAROK_NAMESPACE =
        keccak256("com.aggbridge.library.mappings.amarok");
    bytes32 internal constant PERIPHERY_REGISTRY_NAMESPACE =
        keccak256("com.aggbridge.facets.periphery_registry");
