...
contract Executor is IApp, ReentrancyGuard, TransferrableOwnership, IERC721Receiver {
    /// Storage ///
    ...
    function _processSwaps(
        ...
        if (!LibAsset.isNativeAsset(_transferredAssetId)) {
            ...
            if (_depositAllowance) {
                ...
                LibAsset.depositAsset(bytes32(0), _transferredAssetId, allowance, false, 0, LibAsset.NULL_ADDRESS);
            } else {
    ...
    function _executeSwaps(
        ...
        for (uint256 i = 0; i < numSwaps; ) {
            ...
            LibSwap.swap(_transactionId, currentSwapData, currentSwapData.fromAmount);
            unchecked {
                ++i;
            }
        }
