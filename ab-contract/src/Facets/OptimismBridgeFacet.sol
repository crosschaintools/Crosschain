    ...
    Validatable
{
    ...
    bytes32 internal constant NAMESPACE =
        keccak256("com.aggbridge.facets.optimism");
    ...
    event OptimismInitialized(OptimismConfig[] configs);
    ...
    function initOptimism(
        OptimismConfig[] calldata configs,
        IL1StandardBridge standardBridge
    ) external {
    ...
    function _startBridge(
        ...
        if (LibAsset.isNativeAsset(_bridgeData.sendingAssetId)) {
            bridge.depositETHTo{ value: _bridgeData.preBridgeAmount}(
            ...
            if (_optimismData.isSynthetix) {
                bridge.depositTo(_bridgeData.receiver, _bridgeData.preBridgeAmount);
            } else {
