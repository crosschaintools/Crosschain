...
The deploy script was updated to use legacy (non EIP-1559) transactions due to the fact that some chains that Diamond supports do not support EIP-1559.
...
Diamond Supports a large number of chains and we are only growing. CREATE3 allows us to manage our deployments better as well as make integration by developers more painless.
