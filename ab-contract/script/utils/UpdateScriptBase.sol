...
import { DiamondLoupeFacet } from "app/Facets/DiamondLoupeFacet.sol";

contract UpdateScriptBase is Script {
    using stdJson for string;

    address payable internal diamond;
    ...
    constructor() {
        ...
        diamond = useDefaultDiamond ?
            payable(json.readAddress(".Diamond")) :
            payable(json.readAddress(".DiamondImmutableV1"))
        ;
